...
export type BrandSectionRecord = RecordInterface & {
  ...
  _unpublishingScheduledAt?: Maybe<Scalars['DateTime']['output']>;
  _updatedAt: Scalars['DateTime']['output'];
  brand: Array<BrandShowcaseRecord>;
...
/** Block of type 🏷️ Brand Showcase (brand_showcase) */
export type BrandShowcaseRecord = RecordInterface & {
  __typename?: 'BrandShowcaseRecord';
  _createdAt: Scalars['DateTime']['output'];
  /** Editing URL */
  _editingUrl?: Maybe<Scalars['String']['output']>;
  _firstPublishedAt?: Maybe<Scalars['DateTime']['output']>;
...
/** Block of type 🏷️ Brand Showcase (brand_showcase) */
export type BrandShowcaseRecord_SeoMetaTagsArgs = {
  locale?: InputMaybe<SiteLocale>;
};
